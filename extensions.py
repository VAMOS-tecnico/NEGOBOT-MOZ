...
def init_extensions(app=None):
    ...
    if not firebase_admin._apps:
        # CORREÇÃO CRÍTICA: Remove 'FIREBASE_CONFIG' da memória para evitar que o SDK
        # do Firebase tente ler a variável com erro de sintaxe do .env
        ...
        # 1. PRIORIDADE 1: Ficheiro local serviceAccountKey.json
    ...
    db = firestore.client()import base64
import json
import logging
import os
import firebase_admin
