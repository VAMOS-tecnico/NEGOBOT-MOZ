...
export function VideoPage() {
  ...
  async function create(event: FormEvent) {
    ...
    try { const result = await api.client.createVideoJob({ title, scenes: payloadScenes, language, subtitles: true }); setJob(result.job); setNotice(english ? "Video queued. You can leave this page; the worker continues on the server." : "Vídeo colocado na fila. Podes sair desta página; o worker continua no servidor."); }
