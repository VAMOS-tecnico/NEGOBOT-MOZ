...
const COPY: Record<Language, PublicCopy> = {
  pt: {
    ...
    plansIntro: { title: "Um plano para cada fase do teu negócio.", text: "Preços apresentados em MT para Moçambique. Começa com 2 dias de demonstração; os canais adicionais dependem de autorização e configuração do fornecedor." },
    plans: [
    ...
    cta: { eyebrow: "Começa agora", title: "Pronto para atender melhor?", text: "Cria o teu espaço, testa durante 2 dias depois de ligares o WhatsApp e escolhe o plano certo para a tua operação.", whatsapp: "Falar pelo WhatsApp", platform: "Criar espaço na plataforma" },
  ...
  en: {
    ...
    plansIntro: { title: "A plan for every stage of your business.", text: "International prices are shown in USD. Start with a 2-day demonstration; additional channels depend on provider authorization and setup." },
    plans: [
    ...
    cta: { eyebrow: "Get started", title: "Ready to serve better?", text: "Create your space, test for 2 days after connecting WhatsApp, then choose the plan that fits your operation.", whatsapp: "Talk via WhatsApp", platform: "Create your platform space" },
