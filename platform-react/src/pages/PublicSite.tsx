...
const COPY: Record<Language, PublicCopy> = {
  pt: {
    ...
    plansIntro: { title: "Um plano para cada fase do teu negócio.", text: "Começa com 2 dias de demonstração. Os canais adicionais dependem de autorização e configuração do fornecedor." },
    plans: [
  ...
  en: {
    ...
    plansIntro: { title: "A plan for every stage of your business.", text: "Start with a 2-day demonstration. Additional channels depend on provider authorization and setup." },
    plans: [
      { id: "basico", label: "BASIC", name: "Basic Plan", price: "500 MT", month: "/ month", description: "For businesses ready to start answering consistently.", benefits: ["Up to 1,500 conversations and contacts", "FAQ, hours and text catalog", "1 WhatsApp number and 1 user", "2 campaigns per month", "Basic support within 24 hours"] },
      { id: "medio", label: "GROWTH", name: "Growth Plan", price: "1,000 MT", month: "/ month", description: "For teams that need more context and follow-up.", benefits: ["Up to 5,000 conversations and contacts", "WhatsApp + 1 approved additional channel", "Up to 3 users and 10 campaigns/month", "Photos, basic Excel and reports", "Priority support within 12 hours"] },
      { id: "premium", label: "MOST COMPLETE", name: "Premium Plan", price: "1,500 MT", month: "/ month", description: "For operations ready to automate marketing and customer care.", benefits: ["Up to 15,000 conversations and contacts", "WhatsApp + up to 3 approved channels", "Up to 5 users and 25 campaigns/month", "Advanced AI, audio, PDFs and documents", "Broadcasts and dedicated support"] },
