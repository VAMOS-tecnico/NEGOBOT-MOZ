...
const PLATFORM_REGISTER_URL = "https://app-negobotmoz.duckdns.org/plataforma/register";
...
const COPY: Record<Language, PublicCopy> = {
  pt: {
    ...
    hero: { eyebrow: "Automação omnichannel", titleA: "Atendimento em todos", titleB: "os teus canais.", lead: "O NEGOBOT-MOZ centraliza WhatsApp, Instagram, Facebook, Telegram, TikTok, LinkedIn, X e email para transformar conversas em atendimento consistente e novas oportunidades.", whatsapp: "Falar com assistente WhatsApp", platform: "Criar espaço na plataforma", note: "2 dias de acesso Premium · sem compromisso", signal: "NEGOBOT / CENTRAL", online: "ONLINE", bubble1: "Olá. Preciso de ajuda com o meu pedido.", bubble2: "Claro. Vou verificar os detalhes e orientar-te já de seguida.", bubble2Meta: "10:42 · resposta automática", bubble3: "Também posso enviar um comprovativo?", bubble4: "Sim. Envia a imagem aqui. A visão da IA ajuda-nos a extrair os dados relevantes.", bubble4Meta: "10:43 · visão computacional", float: "Atendimento que não para" },
    trust: "Construído para operações omnichannel modernas",
      capabilities: { title: "Uma camada inteligente para cada canal.", text: "Da primeira mensagem ao acompanhamento humano, o NEGOBOT-MOZ organiza conversas, contactos e campanhas sem perder contexto." },
    ...
    plansIntro: { title: "Um plano para cada fase do teu negócio.", text: "Preços apresentados em MT para Moçambique. Durante os 2 dias, experimenta as capacidades Premium — vídeo, PDFs, áudio, IA e campanhas avançadas — antes de escolher o plano certo." },
    plans: [
      { id: "basico", label: "BÁSICO", name: "Plano Básico", price: "500 MT", month: "/ mês", description: "Para negócios que querem começar a responder com consistência.", benefits: ["Até 1.500 conversas e contactos", "FAQ, horário e catálogo em texto", "1 número de WhatsApp e 1 utilizador", "2 campanhas por mês", "Suporte básico até 24 horas"] },
      { id: "medio", label: "CRESCIMENTO", name: "Plano Médio", price: "1.000 MT", month: "/ mês", description: "Para equipas que precisam de mais contexto e acompanhamento.", benefits: ["Até 5.000 conversas e contactos", "WhatsApp + 1 canal adicional aprovado", "Até 3 utilizadores e 10 campanhas/mês", "Fotos, Excel básico e relatórios", "Suporte prioritário até 12 horas"] },
      { id: "premium", label: "MAIS COMPLETO", name: "Plano Premium", price: "1.500 MT", month: "/ mês", description: "Para operações que querem automatizar marketing e atendimento.", benefits: ["Até 15.000 conversas e contactos", "WhatsApp + até 3 canais aprovados", "Até 5 utilizadores e 25 campanhas/mês", "IA avançada, áudio, PDFs e documentos", "Disparos e suporte dedicado"] },
      { id: "omnichannel_pro", label: "EMPRESARIAL", name: "Omnichannel Pro", price: "Sob consulta", month: "", description: "Para operações com vários canais, equipas e integrações personalizadas.", benefits: ["Todos os canais autorizados", "Mais conversas e utilizadores", "API e integrações personalizadas", "Campanhas avançadas e suporte dedicado"] },
    ],
    ...
    cta: { eyebrow: "Começa agora", title: "Pronto para atender melhor?", text: "Cria o teu espaço, liga o WhatsApp e experimenta todas as capacidades Premium durante 2 dias antes de escolher o plano certo para a tua operação.", whatsapp: "Falar pelo WhatsApp", platform: "Criar espaço na plataforma" },
  ...
  en: {
    ...
    hero: { eyebrow: "Omnichannel automation", titleA: "Customer care across", titleB: "all your channels.", lead: "NEGOBOT-MOZ brings WhatsApp, Instagram, Facebook, Telegram, TikTok, LinkedIn, X and email into one consistent customer-care workspace.", whatsapp: "Talk to the WhatsApp assistant", platform: "Create your platform space", note: "2 days of Premium access · no commitment", signal: "NEGOBOT / CENTRAL", online: "ONLINE", bubble1: "Hi. I need help with my request.", bubble2: "Of course. I will check the details and guide you right away.", bubble2Meta: "10:42 · automated reply", bubble3: "Can I also send a receipt?", bubble4: "Yes. Send the image here. AI vision helps us extract the relevant details.", bubble4Meta: "10:43 · computer vision", float: "Support that never stops" },
    trust: "Built for modern omnichannel operations",
    capabilities: { title: "An intelligent layer for every channel.", text: "From the first message to human follow-up, NEGOBOT-MOZ organizes conversations, contacts and campaigns without losing context." },
    features: [
    ...
    plansIntro: { title: "A plan for every stage of your business.", text: "International prices are shown in USD. Try the full Premium experience — video, PDFs, audio, AI and advanced campaigns — for 2 days before choosing your plan." },
    plans: [
      { id: "basico", label: "BASIC", name: "Basic Plan", price: "$8", month: "/ month", description: "For businesses ready to start answering consistently.", benefits: ["Up to 1,500 conversations and contacts", "FAQ, hours and text catalog", "1 WhatsApp number and 1 user", "2 campaigns per month", "Basic support within 24 hours"] },
      { id: "medio", label: "GROWTH", name: "Growth Plan", price: "$16", month: "/ month", description: "For teams that need more context and follow-up.", benefits: ["Up to 5,000 conversations and contacts", "WhatsApp + 1 approved additional channel", "Up to 3 users and 10 campaigns/month", "Photos, basic Excel and reports", "Priority support within 12 hours"] },
      { id: "premium", label: "MOST COMPLETE", name: "Premium Plan", price: "$24", month: "/ month", description: "For operations ready to automate marketing and customer care.", benefits: ["Up to 15,000 conversations and contacts", "WhatsApp + up to 3 approved channels", "Up to 5 users and 25 campaigns/month", "Advanced AI, audio, PDFs and documents", "Broadcasts and dedicated support"] },
      { id: "omnichannel_pro", label: "BUSINESS", name: "Omnichannel Pro", price: "On request", month: "", description: "For operations with multiple channels, teams and custom integrations.", benefits: ["All authorized channels", "More conversations and users", "API and custom integrations", "Advanced campaigns and dedicated support"] },
    ],
    ...
    cta: { eyebrow: "Get started", title: "Ready to serve better?", text: "Create your space, connect WhatsApp and try the full Premium experience for 2 days before choosing the plan that fits your operation.", whatsapp: "Talk via WhatsApp", platform: "Create your platform space" },
...
export function PublicSite() {
  ...
  return <div className="public-site" id="top"><PublicNav language={language} setLanguage={setLanguage} copy={copy} onAssistant={() => setAssistantOpen(true)} /><main>
    <section className="public-hero"><div className="public-hero-glow" /><div className="public-container public-hero-grid"><div className="public-hero-copy"><p className="public-eyebrow">{copy.hero.eyebrow}</p><h1>{copy.hero.titleA}<br /><em>{copy.hero.titleB}</em></h1><p className="public-lead">{copy.hero.lead}</p><div className="public-actions"><a className="public-button public-button-primary" href="/falar-whatsapp">{copy.hero.whatsapp} <ArrowUpRight size={17} /></a><a className="public-button public-button-ghost" href={PLATFORM_REGISTER_URL}>{copy.hero.platform} <ArrowUpRight size={17} /></a></div><p className="public-note"><span className="public-live-dot" /> {copy.hero.note}</p></div><div className="public-signal-card" aria-label="NEGOBOT-MOZ conversation example"><div className="public-card-top"><span>{copy.hero.signal}</span><span className="public-live">{copy.hero.online}</span></div><div className="public-chat-window"><div className="public-bubble">{copy.hero.bubble1}<small>10:42</small></div><div className="public-bubble public-bubble-bot">{copy.hero.bubble2}<small>{copy.hero.bubble2Meta}</small></div><div className="public-bubble">{copy.hero.bubble3}<small>10:43</small></div><div className="public-bubble public-bubble-bot">{copy.hero.bubble4}<small>{copy.hero.bubble4Meta}</small></div></div><div className="public-float-label"><span><CheckCircle2 size={16} /></span>{copy.hero.float}</div></div></div></section>
    <section className="public-trust" aria-label="Canais suportados"><div className="public-container public-trust-inner"><span>{copy.trust}</span><div className="public-channel-brands"><span title="WhatsApp"><SiWhatsapp /></span><span title="Instagram"><SiInstagram /></span><span title="Facebook"><SiFacebook /></span><span title="Telegram"><SiTelegram /></span><span title="TikTok"><SiTiktok /></span><span title="LinkedIn"><FaLinkedin /></span><span title="X"><SiX /></span><span title="Email"><SiGmail /></span></div></div></section>
    ...
    <section className="public-section public-plans-section" id="planos"><div className="public-container"><div className="public-section-head"><h2>{copy.plansIntro.title}</h2><p>{copy.plansIntro.text}</p></div><div className="public-plans-grid">{copy.plans.map((plan) => <article className={`public-plan ${plan.id === "premium" ? "public-plan-featured" : ""}`} key={plan.id}><p className="public-plan-label">{plan.label}</p><h3>{plan.name}</h3><p className="public-plan-description">{plan.description}</p><div className="public-price">{plan.price}<small>{plan.month}</small></div><ul>{plan.benefits.map((benefit) => <li key={benefit}><Check size={15} />{benefit}</li>)}</ul><a className={`public-button ${plan.id === "premium" ? "public-button-primary" : "public-button-light"}`} href={plan.id === "omnichannel_pro" ? "/assistente" : `${PLATFORM_REGISTER_URL}?plan=${encodeURIComponent(plan.id)}&lang=${language}`}>{plan.id === "omnichannel_pro" ? (language === "pt" ? "Falar com especialista" : "Talk to a specialist") : `${copy.choose} ${plan.name.replace(language === "pt" ? "Plano " : " Plan", "")}`} <ChevronRight size={16} /></a></article>)}</div></div></section>
