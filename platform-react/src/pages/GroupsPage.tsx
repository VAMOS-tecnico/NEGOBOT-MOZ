...
import { CheckCircle2, Loader2, MessageCircle, Plus, RefreshCw, Save, ShieldCheck, Users, XCircle } from "lucide-react";
...
function groupStatus(group: WhatsAppGroup) {
  if (!group.admin_verified || !group.bot_is_admin) return "Rejeitado: a instância não é administradora";
  if (!group.automation_enabled) return "Verificado, automação desligada";
  return "Activo e administrado pelo teu WhatsApp";
}
