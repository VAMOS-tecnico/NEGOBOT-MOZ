...
import { AssistantPage, BillingPage, BusinessProfilePage, CampaignsPage, MetricsPage, SupportPage, TeamPage, VideoPage, WhatsAppPage } from "./pages/ClientPages";
...
function PlatformRouter({ user, onLogout }: { user: PlatformUser; onLogout: () => void }) { return <AppShell user={user} onLogout={onLogout}><Routes><Route index element={<OverviewPage user={user} />} /><Route path="conversas" element={<TenantRoute user={user}><ChatPage /></TenantRoute>} /><Route path="campanhas" element={<TenantRoute user={user}><CampaignsPage /></TenantRoute>} /><Route path="whatsapp" element={<TenantRoute user={user}><WhatsAppPage /></TenantRoute>} /><Route path="empresa" element={<TenantRoute user={user}><BusinessProfilePage /></TenantRoute>} /><Route path="equipa" element={<TenantRoute user={user}><TeamPage /></TenantRoute>} />
