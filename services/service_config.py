...
PROFILES: dict[str, ServiceProfile] = {
    ...
    "video": ServiceProfile(
        ...
        optional=("VIDEO_QUEUE", "VIDEO_OUTPUT_DIR", "VIDEO_RETENTION_DAYS", "PEXELS_API_KEY", "PEXELS_PER_PAGE", "PEXELS_TIMEOUT_SECONDS", "ELEVENLABS_API_KEY", "ELEVENLABS_API_BASE", "ELEVENLABS_MODEL", "HEYGEN_API_KEY", "HEYGEN_API_BASE", "HEYGEN_CREATE_PATH", "HEYGEN_STATUS_PATH", "HEYGEN_TIMEOUT_SECONDS"),
    ),
    "ai": ServiceProfile(
        required=("REDIS_URL",),
        optional=(
